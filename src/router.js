  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/gambling/guangdongkuaile10', name: 'guangdongkuaile10',
          meta: {
              requireAuth: true,
          },
          component: r => require.ensure([], () => r(require('@/components/apps/bocai/guangdongkuaile10')), 'guangdongkuaile10'), meta: { requiresAuth: true }
        },
        { path: '/gambling/testbocai', name: 'testbocai',
          meta: {
              requireAuth: true,
          },
          component: r => require.ensure([], () => r(require('@/components/apps/bocai/testbocai')), 'testbocai'), meta: { requiresAuth: true }
        },
        ...
        { path: '/gambling/changePassword', name: 'changePassword',
          meta: {
              requireAuth: true,
          },
          component: r => require.ensure([], () => r(require('@/components/apps/submenu/changePassword')), 'changePassword'), meta: { requiresAuth: true }
        }
